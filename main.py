...
# -*- coding: utf-8 -*-
"""
Scraper de Contactos Casafari con ScraperAPI
Extrae teléfonos y emails de viviendas de particulares en Casafari España
"""
...
CIUDADES_CASAFARI = {
    'madrid': 'https://www.casafari.com/comprar-piso-o-casa-madrid_madrid/',
    'barcelona': 'https://www.casafari.com/comprar-piso-o-casa-barcelona_barcelona/',
    'valladolid': 'https://www.casafari.com/comprar-piso-o-casa-valladolid_valladolid/',
    'valencia': 'https://www.casafari.com/comprar-piso-o-casa-valencia_valencia/',
    'sevilla': 'https://www.casafari.com/comprar-piso-o-casa-sevilla_sevilla/',
    'zaragoza': 'https://www.casafari.com/comprar-piso-o-casa-zaragoza_zaragoza/',
    'malaga': 'https://www.casafari.com/comprar-piso-o-casa-malaga_malaga/',
    'murcia': 'https://www.casafari.com/comprar-piso-o-casa-murcia_murcia/',
    'bilbao': 'https://www.casafari.com/comprar-piso-o-casa-bilbao_bilbao/',
    'alicante': 'https://www.casafari.com/comprar-piso-o-casa-alicante_alicante/',
}
...
def scrape_casafari_contacts(base_url: str, page: int = 1, max_properties: int = 10):
    """Extrae contactos de propiedades en Casafari"""
    try:
        ...
        for article in soup.find_all("article", class_="property-item"):
            if len(properties) >= max_properties:
                break
            
            title_el = article.select_one("a.property-link, h2.property-title")
            price_el = article.select_one(".property-price, .price")
            location_el = article.select_one(".property-location, .location")
            
            url_rel = title_el["href"] if title_el and title_el.has_attr("href") else None
            if url_rel and not url_rel.startswith("http"):
                url_abs = "https://www.casafari.com" + url_rel
            else:
                url_abs = url_rel
            ...
            # Extraer ID
            id_match = re.search(r'/(\d+)/?$', url_abs or "")
        ...
        logger.error(f"Error in scrape_casafari_contacts: {e}")
        raise
...
def get_contacts(city='madrid'):
    try:
        city = city.lower()
        base_url = CIUDADES_CASAFARI.get(city, CIUDADES_CASAFARI['madrid'])
        ...
        data = scrape_casafari_contacts(base_url, page=page, max_properties=max_properties)
...
def get_cities():
    return jsonify({
        'success': True,
        'cities': list(CIUDADES_CASAFARI.keys())
    }), 200
